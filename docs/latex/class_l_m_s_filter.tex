...
void \mbox{\hyperlink{class_l_m_s_filter_a223ccaf430321b1b8e6cab7ccb4d11a8}{process\+Buffer}} (const float32\+\_\+t \texorpdfstring{$\ast$}{*}input\+Array, const float32\+\_\+t \texorpdfstring{$\ast$}{*}reference\+Array, float32\+\_\+t \texorpdfstring{$\ast$}{*}output\+Array, float32\+\_\+t \texorpdfstring{$\ast$}{*}error\+Array, uint32\+\_\+t length)
...
\end{DoxyNote}
\Hypertarget{class_l_m_s_filter_a223ccaf430321b1b8e6cab7ccb4d11a8}\index{LMSFilter@{LMSFilter}!processBuffer@{processBuffer}}
\index{processBuffer@{processBuffer}!LMSFilter@{LMSFilter}}
\doxysubsubsection{\texorpdfstring{processBuffer()}{processBuffer()}}
{\footnotesize\ttfamily \label{class_l_m_s_filter_a223ccaf430321b1b8e6cab7ccb4d11a8} 
void LMSFilter\+::process\+Buffer (\begin{DoxyParamCaption}\item[{const float32\+\_\+t \texorpdfstring{$\ast$}{*}}]{input\+Array}{, }\item[{const float32\+\_\+t \texorpdfstring{$\ast$}{*}}]{reference\+Array}{, }\item[{float32\+\_\+t \texorpdfstring{$\ast$}{*}}]{output\+Array}{, }\item[{float32\+\_\+t \texorpdfstring{$\ast$}{*}}]{error\+Array}{, }\item[{uint32\+\_\+t}]{length}{}\end{DoxyParamCaption})}
